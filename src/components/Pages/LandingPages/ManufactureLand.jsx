    ...
    <div>
      ...
      <div className="topc">
        ...
        <div className="img-lod">
          <img
            className="img11"
            src="https://timebusinessnews.com/wp-content/uploads/CriticalAssetTracking-1600x945-01-1-800x445.jpg"
          ></img>
        </div>
      </div>
      <div className="twop" style={{ fontFamily: "Helvetica Now" }}>
        <div className="row1">
          ...
          <h2 style={{ fontSize: "25px", fontWeight: "600" }}>MANUFACTURER</h2>
          <br />
        ...
        <div className="row2">
          ...
          <h2 style={{ fontSize: "25px", fontWeight: "600" }}>DEALER</h2>
          <br />
          <h2 style={{ fontSize: "15px", fontWeight: "400" }}>
        ...
        <div className="row3">
          ...
          <h2 style={{ fontSize: "25px", fontWeight: "600" }}>CUSTOMER</h2>
          <br />
          <h2 style={{ fontSize: "15px", fontWeight: "400" }}>
      ...
      <div className="part3">
        <div className="floating">
          <img
            className="flow"
            src="https://www.inpixon.com/hs-fs/hubfs/website_graphics/diagrams/how-rtls-works-diagram.png?width=2411&height=1668&name=how-rtls-works-diagram.png"
          ></img>
        </div>
        <div className="pc">
          <h2 className="t1">Tracking made easy</h2>
          <br />
          <h7 classname="t2" style={{ fontSize: "14px", color: "#beceda" }}>
